...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aodhclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10094&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aodhclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aodhclient` can be installed with:

```
conda install aodhclient
```

It is possible to list all of the versions of `aodhclient` available on your platform with:
